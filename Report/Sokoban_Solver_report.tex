...
% Brief outline how puzzle class interacts with search class 
\subsubsection{Taboo Cells}
% Explain taboo cells function:
    % Modified Breadth first search algorithm to determine interior cells
    % is_corner method applied to all interior cells using transforms to calculate adjacents cells and thus determine corners
...
% Method how we used a mixture of black box white box testing
    % I.E Some tests were done prior to completing methods 
